 ...
 */
@WebServlet("/studentuploaddirectplan")
public class studentuploaddirectplan extends HttpServlet {
	private static final long serialVersionUID = 1L;
	studentdataDao sdao=new studentdataDao();   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public studentuploaddirectplan() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
			...
			if(request.getParameter("studentuploadre")!=null) {
				if(request.getParameter("studentuploadre").equals("yes")) {
			String major=sdao.majorofstudent((String) request.getSession().getAttribute("studentusername"));
			String pp=request.getServletContext().getRealPath("/WEB-INF/directplan/");
		   ...
		   String savepath=request.getServletContext().getRealPath("/WEB-INF/directplan/"+major+"/");
