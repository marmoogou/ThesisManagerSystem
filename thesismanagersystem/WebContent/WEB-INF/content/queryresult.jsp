<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%@ page import="thesisdata.*,teacherdata.*" %>
...
if(request.getSession().getAttribute("thesisdataforresult" )!=null&&request.getSession().getAttribute("teacherdataforresult")!=null){
	
	 data=(thesisdata)request.getSession().getAttribute("thesisdataforresult" );
	 datademo=(teacherdata)request.getSession().getAttribute("teacherdataforresult" );
}else{
	
	request.getRequestDispatcher("studentpage.action").forward(request, response);
