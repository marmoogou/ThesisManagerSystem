				...
				<div class="s-content-down-r">
					...
					<ul class="info">
						...
						<li class="change">
							...
							<form action="administratorpage.action?updatess=yes" method="post">
								<input type="text" name="updatesname"/>
								<input type="text" name="updatessex"/>
								<input type="text"   name="updatesid"/>
								<input type="text"  name="updatesmajor"/>
								<input type="text" name="updatesgrade"/>
								
								
								<input type="text"  name="updatespassword"/>
								<input type="text"  name="updatesqq"/>
								<input type="text"  name="updatesemail"/>
								<input type="text"  name="updatestel"/>
								<input class="submit" type="submit" name="" id="" value="确认录入并保存" />
							</form>
